...
Comments are very nice but they should be used sparingly and only when they add value, they hsould only explain code that isn't obvious or self-explanatory. <br>
Good Example:
