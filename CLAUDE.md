...
| 0009 | One protocol that differs by a Host id, a merged stream to the Client, and an Event written before it is sent | the wire protocol, the SQLite log, replay, retention | 40 KB |

Everything after 0004 is long. The nine together are about 51,000 tokens, which is why
