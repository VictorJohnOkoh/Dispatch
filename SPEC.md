...
serves both from one copy. The VRAM policy that decides whether a load may happen at all is still out
of v1; this is only the other half of a call v1 already makes.
